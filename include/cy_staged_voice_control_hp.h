...
/**
 * \defgroup group_svc_hp_macros SVC_HP Macros
 * \defgroup group_svc_hp_enums SVC_HP Enumerated types
 * \defgroup group_svc_hp_typedefs SVC_HP Typedefs
 * \defgroup group_svc_hp_structures SVC_HP Structures
 * \defgroup group_svc_hp_functions SVC_HP Functions
 */
...
/**
 * \addtogroup group_svc_hp_typedefs
 * \{
 */
/**
 ...
 * the data sent.
 *
 * Application must register this callback using the API cy_svc_hp_init
 *
 ...
 * @param[in] callback_user_arg     User argument passed in cy_svc_hp_init
 *
 ...
 ******************************************************************************/
/**
 * \addtogroup group_svc_hp_structures
 * \{
 */
/**
 ...
 ******************************************************************************/
/**
 * \addtogroup group_svc_hp_functions
 * \{
 */
/**
 ...
 *                                  example:
 *                                  For state CY_SVC_SET_STATE_HIGH_PERFORMANCE_DETECT_IN_PROGRESS the
 *                                  state-info is cy_svc_hp_set_state_hpwwd_detection_in_prog_info_t,
 *                                  For state CY_SVC_SET_STATE_ASR_DETECTED the
 *                                  state-info is cy_svc_hp_set_state_asr_detected_info_t,
 ...
 * deletes the resources created during cy_svc_hp_init
 *
 * \note After invoking \ref cy_svc_hp_deinit on either core,
 * \ref cy_svc_hp_init cannot be invoked again. The expectation is that
 * \ref cy_svc_hp_init and \ref cy_svc_hp_deinit should be invoked only once.
 *
 * \note Application should take care of not calling any of SVC MW LP APIs (cy_svc_hp_set_state
...
/**
 * \brief Pre-send hook for IPC communication.
 *
 * This weak function can be overridden by the application to perform actions before sending IPC messages.
 */
void cy_svc_hp_ipc_pre_send_hook(void);

/**
 * \brief Post-send hook for IPC communication.
 *
 * This weak function can be overridden by the application to perform actions after sending IPC messages.
 */
void cy_svc_hp_ipc_post_send_hook(void);

/**
 * \brief Post-receive hook for IPC communication.
 *
 * This weak function can be overridden by the application to perform actions after receiving IPC messages.
 */
void cy_svc_hp_ipc_post_recv_hook(void);

/** \} group_svc_hp_functions */
