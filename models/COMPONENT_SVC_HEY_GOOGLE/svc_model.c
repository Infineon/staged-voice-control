...
#include "HEY_GOOGLE_INT8_tflm_model_int8x8.h"

const bool SVC_MODEL_DUAL_WAKEWORD_ENABLED = false;
const char *SVC_MODEL_BINARY_BUFFER = (const char*) HEY_GOOGLE_INT8_model_bin;
const char *SVC_MODEL_PARAMS_BUFFER = (const char*) NULL;
const unsigned int SVC_MODEL_ARENA_BUFFER_SIZE = HEY_GOOGLE_INT8_ARENA_SIZE;
#else
const bool SVC_MODEL_DUAL_WAKEWORD_ENABLED = false;
...
const char *SVC_MODEL_PARAMS_BUFFER = (const char*) NULL;
    ...
    #include "HEY_GOOGLE_2023-10-14_pp_kw_hmm_int8_nn.h"
            };
    const int16_t ppgmodel1_input[] = {
    #include "HEY_GOOGLE_2023-10-14_pp_g_hmm_int8_nn.h"
            };
    const int16_t ppnmodel1_input[] = {
    #include "HEY_GOOGLE_2023-10-14_pp_n_hmm_int8_nn.h"
            };
    ...
    const int32_t lpwwd_pp_config_params[] = {
        #include "HEY_GOOGLE_LPWWD_PP_parms.h"
        };
